...
public final class home_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (!session.getAttribute("logado").equals("true")) {
      ...
      out.write("                    <input type=\"search\" class=\"busca\" name=\"q\" placeholder=\"Busca...\">\n");
      ...
      out.write("            ");
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        p.setCodigo(rs.getInt("pub_codigo"));
                        p.setTitulo(rs.getString("pub_titulo"));
                        p.setDescricao(rs.getString("pub_texto"));
                        p.setArquivo(rs.getString("pub_arquivo"));
                        p.setUsuario(rs.getInt("usu_codigo"));
                ...
                for (int ct = 0; ct < cont; ct++) {
            
      out.write("\n");
      out.write("\n");
      out.write("            <div class=\"publ\">\n");
      out.write("                <p class=\"p1\">");
      out.print( pub.get(ct).getTitulo());
      out.write("</p>\n");
      out.write("                <p class=\"p2\">");
      out.print( pub.get(ct).getDescricao());
      out.write("</p>\n");
      out.write("                ");

                    String cam, aux = pub.get(ct).getArquivo();
                    int n = aux.lastIndexOf("web");
                    n = n + 3;
                    cam = aux.substring(n);

                    String tipo;
                    int m = cam.lastIndexOf(".");
                    tipo = cam.substring(m);

                    if (tipo.equals(".avi") || tipo.equals(".mov")
                            || tipo.equals(".mp4") || tipo.equals(".mov")) {

                
      out.write("\n");
      out.write("\n");
      out.write("                <video class=\"imp\" src=\".");
      out.print(cam);
      out.write("\" >\n");
      out.write("                    ");
} else {
